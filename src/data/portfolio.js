...
export const projects = [
  ...
  },
  {
    ...
    year: "2025",
    tags: ["React 19", "TypeScript", "Vite", "MUI 7", "React Query 5", "Formik + Yup"],
    description:
      "Clon profesional de Mercado Libre con catálogo de productos desde FakeStore API, filtros dinámicos por URL params, carrito persistente con React Context, checkout multi-paso con Formik + Yup, modo oscuro, loading skeletons y diseño responsive mobile-first. Routing con React Router 7, code splitting por ruta (React.lazy) y vendor chunking (bundle principal de 227 KB). Sistema de diseño propio con 60+ CSS Custom Properties y dark mode con persistencia en localStorage.",
    highlights: [
      "Diseño inspirado en Mercado Libre (precios con superscript, cuotas, envío gratis)",
      "Filtros dinámicos persistidos en URL params (compartibles)",
      "Carrito persistente con subtotales automáticos y control de cantidades",
      "Checkout multi-paso con validación Formik + Yup (nombre, email, teléfono, dirección)",
      "Code splitting + vendor chunking: bundle principal de 227 KB (-56%)",
      "Dark mode con CSS Custom Properties + persistencia localStorage",
      "Loading skeletons con MUI para todas las vistas asíncronas",
      "Fuente Inter de Google Fonts · Micro-interacciones y animaciones sutiles",
    ],
    color: "#3483FA",
    emoji: "🛒",
    image: "/img-ecommerce.png",
    github: "https://github.com/Gerardo-Rioss/Clon_Ecommerce_React",
    live: "https://ecommerce-clon.netlify.app",
  },
  {
    id: 3,
